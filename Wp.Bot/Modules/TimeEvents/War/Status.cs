...
namespace Wp.Bot.Modules.TimeEvents.War
{
    public static class Status
    {
        ...
        private static async Task WarnManagerApiOffline(IGuildUser manager, Competition competition)
        {
            // Gets text
        ...
        private static async Task WarnPlayerApiOffline(IGuildUser user, Player player, Competition competition)
        {
            // Gets text
        ...
        private static async Task WarnManagerAsync(IGuildUser manager, Player[] players, Competition dbCompetition)
        {
            ...
            {
                await WarnManagerApiOffline(manager, dbCompetition);
        ...
        private static async Task WarnPlayerAsync(IGuild guild, Player player, Competition dbCompetition)
        {
            ...
            if (!await ClashOfClansApi.TryAccessApiAsync())
            {
                await WarnPlayerApiOffline(user, player, dbCompetition);
