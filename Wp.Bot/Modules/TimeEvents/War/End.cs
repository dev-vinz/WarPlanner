    ...
    public static class End
    {
            ...
            image.Mutate(ctx =>
            {
                ...
                players
                    ...
                    .ForAll(tuple =>
                    {
                        ...
                        ctx.DrawText(new RichTextOptions(font) { HorizontalAlignment = HorizontalAlignment.Right, Origin = new(1235, 80 + factor * 60) }, opponentPlayer.Name, Color.White);
                        ...
                        ctx.DrawText(new RichTextOptions(font) { HorizontalAlignment = HorizontalAlignment.Right, Origin = new(825, 80 + factor * 60) }, $"{opponentPlayer.Attacks?.Aggregate(0, (acc, a) => acc += a.DestructionPercentage):#0.00}%", Color.White);
                    });
            });
        ...
        private static async Task<FileAttachment> GetMainResult(ClashOfClans.Models.ClanWar cWar, Guild guild)
        {
            ...
            image.Mutate(ctx =>
            {
                ...
                ctx.DrawText(new RichTextOptions(fontClans) { HorizontalAlignment = HorizontalAlignment.Right, Origin = new(975, 110) }, cWar.Opponent.Name!, color);
                ...
                ctx.DrawText(new RichTextOptions(fontInfos) { HorizontalAlignment = HorizontalAlignment.Right, Origin = new(975, 165) }, $"{cWar.Opponent.DestructionPercentage:#0.00}%", color);
                ctx.DrawText(new RichTextOptions(fontInfos) { HorizontalAlignment = HorizontalAlignment.Right, Origin = new(975, 195) }, $"{opponentDuration:%m}{guild.GeneralResponses.ShortcutMinute} {opponentDuration:ss}{guild.GeneralResponses.ShortcutSecond}", color);

                // Draw stars
                Font fontStars = fontFamily.CreateFont(70, FontStyle.Bold);

                ctx.DrawText(new RichTextOptions(fontStars) { HorizontalAlignment = HorizontalAlignment.Right, Origin = new(590, 165) }, $"{cWar.Clan.Stars}", color);
                ...
                players
                    ...
                    .ForAll(tuple =>
                    {
                        ...
                        ctx.DrawText(new RichTextOptions(font) { HorizontalAlignment = HorizontalAlignment.Right, Origin = new(1235, 308 + factor * 60) }, opponentPlayer.Name, Color.White);
                        ...
                        ctx.DrawText(new RichTextOptions(font) { HorizontalAlignment = HorizontalAlignment.Right, Origin = new(825, 308 + factor * 60) }, $"{opponentPlayer.Attacks?.Aggregate(0, (acc, a) => acc += a.DestructionPercentage):#0.00}%", Color.White);
                    });
            });
