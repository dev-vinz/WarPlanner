...
namespace Wp.Api
{
    public static class ClashOfClansApi
    {
        ...
        public static async Task<bool> TryAccessApiAsync()
        {
            ...
            {
                ChangeClashOfClansError(exception);
        ...
        /// <summary>
        /// Changes the default error status of the API
        /// </summary>
        /// <param name="exception">A Clash of Clans exception</param>
        private static void ChangeClashOfClansError(ClashOfClansException exception)
        {
            Error = exception.Error.Reason switch
            {
                "notFound" => ClashOfClansError.NOT_FOUND,
                "inMaintenance" => ClashOfClansError.IN_MAINTENANCE,
                "accessDenied.invalidIp" => ClashOfClansError.INVALID_IP,
