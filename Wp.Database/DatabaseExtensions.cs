...
namespace Wp.Database
{
    public static class DatabaseExtensions
    {
        ...
        {
            return calendars.AsEnumerable().FirstOrDefault(c => c.Guild == calendar.Guild.Id);
        }
        ...
        {
            return clans.AsEnumerable().FirstOrDefault(c => c.Guild == clan.Guild.Id && c.Tag == clan.Tag);
        }
        ...
        {
            return competitions.AsEnumerable().FirstOrDefault(c => c.Guild == competition.Guild.Id && c.CategoryId == competition.Id);
        }
        ...
        {
            return guilds.AsEnumerable().FirstOrDefault(g => g.Id == guild.Id);
        }
        ...
        {
            return players.AsEnumerable().FirstOrDefault(p => p.Guild == player.Guild.Id && p.Tag == player.Tag);
        }
        ...
        {
            return playerStatistics.AsEnumerable().FirstOrDefault(ps => ps.DiscordId == playerStatistic.PlayerId &&
        ...
        {
            return roles.AsEnumerable().FirstOrDefault(r => r.Id == role.Id && r.Type == (int)role.Type);
        }
        ...
        {
            return times.AsEnumerable().FirstOrDefault(t => t.Guild == time.Guild.Id && t.Action == (int)time.Action && t.Additional == time.Additional);
        }
